...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    NextGame(request) {
        const data = QueryGetNextGameRequest.encode(request).finish();
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "NextGame", data);
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "StoredGame", data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "StoredGameAll", data);
    ...
    CanPlayMove(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "CanPlayMove", data);
    ...
    PlayerInfo(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "PlayerInfo", data);
    ...
    PlayerInfoAll(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "PlayerInfoAll", data);
    ...
    Leaderboard(request) {
        ...
        const promise = this.rpc.request("zjing20.checkers.checkers.Query", "Leaderboard", data);
